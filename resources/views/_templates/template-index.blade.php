            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card shadow-sm no-hover">
                        <div class="card-header bg-white py-3 d-flex align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary d-flex flex-grow-1">Lista de {Module}s</h6>
                            <div class="input-group w-25">
                                <form action="{{ route('{module}.index') }}" method="GET" class="input-group">
                                    <input type="text" name="search" class="form-control form-control-sm" 
                                        placeholder="Buscar {module}..." value="{{ request('search') }}" autocomplete="off">
