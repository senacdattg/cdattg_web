...
<head>
    ...
    {{-- Estilos base AdminLTE (publicados en /public/plugins y /public/dist) --}}
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @php
            ...
            $userImage =
                $persona && $persona->foto ? asset('storage/' . $persona->foto) : asset('dist/img/LogoSena.png');
                ...
                <li class="nav-item dropdown user-menu ml-auto">
                    @auth
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ $userImage }}" class="user-image img-circle elevation-2"
                                alt="{{ $persona ? $persona->primer_nombre : 'User' }}">
