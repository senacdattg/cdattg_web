        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="h3 mb-0 text-gray-800">Crear Ficha de Caracterización</h1>
                        <p class="text-muted mb-0 font-weight-light">Registrar nueva ficha de caracterización</p>
                    </div>
                </div>
                <div class="col-sm-6">
...
<script>
    ...
    // Validación del formulario - VERSIÓN SIMPLIFICADA PARA DEBUG
