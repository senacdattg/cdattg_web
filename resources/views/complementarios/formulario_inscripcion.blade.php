        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                <div class="text-center mb-4">
                    <h2 class="text-primary" style="color: #007bff !important;">Formulario de Inscripción</h2>
                    <p class="text-muted">Complete sus datos para inscribirse</p>
                </div>
                <div class="card" style="background-color: #ffffff; border-color: #343a40;">
                    <div class="card-header" style="background-color: #007bff; color: #ffffff;">
                        <h3 class="card-title">
                            <i class="fas fa-user-plus mr-2"></i>Formulario de Inscripción
                        </h3>
                        <div class="card-tools">
                            <a href="{{ route('programas-complementarios.publicos') }}" class="btn btn-outline-light btn-sm">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <form id="formInscripcion" method="POST"
                               ...
                               @include('complementarios.components.form-datos-personales', [
                                ...
                                <div class="card mb-4" style="background-color: #ffffff; border-color: #343a40;">
                                    <div class="card-header" style="background-color: #007bff; color: #ffffff;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @foreach ($categoriasConHijos as $categoria)
                                            <div class="card card-outline mb-3" style="border-color: #343a40;">
                                ...
                                <div class="card mb-4" style="background-color: #ffffff; border-color: #343a40;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <button type="submit" class="btn btn-primary" style="background-color: #007bff; border-color: #007bff;">Enviar Inscripción</button>
                                        </div>
                ...
                <div class="col-md-4">
                    <div class="card card-widget widget-user">
                        <div class="widget-user-header" style="background-color: #007bff;">
