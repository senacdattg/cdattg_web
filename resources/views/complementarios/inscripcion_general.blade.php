                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="numero_documento" value="{{ old('numero_documento') }}" name="numero_documento" placeholder="Número de documento" required inputmode="numeric">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="primer_nombre" value="{{ old('primer_nombre') }}" placeholder="Primer Nombre" name="primer_nombre" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="segundo_nombre">Segundo Nombre</label>
                                            <input type="text" class="form-control" id="segundo_nombre" value="{{ old('segundo_nombre') }}" placeholder="Segundo Nombre" name="segundo_nombre">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="primer_apellido">Primer Apellido *</label>
                                            <input type="text" class="form-control" id="primer_apellido" value="{{ old('primer_apellido') }}" placeholder="Primer Apellido" name="primer_apellido" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="segundo_apellido">Segundo Apellido</label>
                                            <input type="text" class="form-control" id="segundo_apellido" value="{{ old('segundo_apellido') }}" placeholder="Segundo Apellido" name="segundo_apellido">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" name="fecha_nacimiento" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" id="telefono" value="{{ old('telefono') }}" name="telefono" placeholder="Teléfono fijo" inputmode="tel">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="celular">Celular *</label>
                                            <input type="tel" class="form-control" id="celular" value="{{ old('celular') }}" name="celular" placeholder="Número de celular" required inputmode="tel">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="email">Correo Electrónico *</label>
                                            <input type="email" class="form-control" id="email" value="{{ old('email') }}" placeholder="Correo electrónico" name="email" required inputmode="email">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="direccion" value="{{ old('direccion') }}" name="direccion" placeholder="Dirección completa" required>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-12 mb-4">
                                            ...
                                            @foreach($categoria['hijos'] as $hijo)
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" id="categoria_{{ $hijo->id }}" name="categorias[]" value="{{ $hijo->id }}"
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="observaciones" name="observaciones" rows="3" placeholder="Información adicional que considere relevante...">{{ old('observaciones') }}</textarea>
                                        </div>
                                    </div>
                                </div>
