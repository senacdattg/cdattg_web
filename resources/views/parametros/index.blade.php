                            ...
                            <div class="input-group w-25">
                                <form action="{{ route('parametro.index') }}" method="GET" class="input-group">
                                    <input type="text" name="search" id="searchParameter"
                                        class="form-control form-control-sm" placeholder="Buscar parámetro..."
                                    ...
                                    <tbody>
                                        @forelse ($parametros as $parametro)
                                            <tr>
                                                ...
                                                <td class="px-4">
                                                    <div
                                                        class="d-inline-block px-3 py-1 rounded-pill {{ $parametro->status === 1 ? 'bg-success-light text-success' : 'bg-danger-light text-danger' }}">
                                                ...
                                                <td class="px-4 text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        @endcan
                                                        @can('VER PARAMETRO')
                                                            <a href="{{ route('parametro.show', ['parametro' => $parametro->id]) }}"
