                            ...
                            <div class="input-group w-25">
                                <form action="{{ route('tema.index') }}" method="GET" class="input-group">
                                    <input type="text" name="search" id="searchParameter"
                                        class="form-control form-control-sm" placeholder="Buscar tema..."
                                    ...
                                    <tbody>
                                        @forelse ($temas as $tema)
                                            <tr>
                                                ...
                                                <td class="px-4">
                                                    <div
                                                        class="ml-3 d-inline-block px-3 py-1 rounded-pill {{ $tema->status === 1 ? 'bg-success-light text-success' : 'bg-danger-light text-danger' }}">
