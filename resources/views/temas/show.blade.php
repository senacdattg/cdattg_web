                ...
                <div class="card detail-card no-hover">
                            ...
                            <table class="table detail-table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3">
                                            <span class="status-badge {{ $tema->status === 1 ? 'text-success' : 'text-danger' }}">
                    ...
                    <div class="card-footer bg-white py-3">
                        <div class="d-flex justify-content-center gap-2">
                            @can('EDITAR TEMA')
                            <form action="{{ route('tema.cambiarEstado', ['tema' => $tema->id]) }}" method="POST" class="d-inline mx-1">
                                @csrf
                                @method('PUT')
                            ...
                            <a href="{{ route('tema.edit', ['tema' => $tema->id]) }}" class="btn btn-outline-info btn-sm mx-1">
                                <i class="fas fa-pencil-alt mr-1"></i> Editar
                            </a>
                            @endcan
                            @can('ELIMINAR TEMA')
                            <form action="{{ route('tema.destroy', ['tema' => $tema->id]) }}" method="POST" class="d-inline mx-1 formulario-eliminar">
                                @csrf
                                @method('DELETE')
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pl-3 align-middle">
                                            <span class="d-inline-block px-3 py-1 rounded-pill {{ $parametro->pivot->status == 1 ? 'bg-success-light text-success' : 'bg-danger-light text-danger' }}">
                                                <i class="fas fa-circle mr-1" style="font-size: 8px;"></i>
