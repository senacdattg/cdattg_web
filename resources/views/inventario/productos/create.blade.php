            ...
            <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" class="form_flex">
                ...
                <div class="row w-100">
                    <div class="col-md-6 mb-4 form-floating">
                        <input type="text" name="producto" id="producto" class="form-control form-control-sm" value="{{ old('producto') }}" required placeholder="Nombre">
                    ...
                    <div class="col-md-6 mb-4 form-floating">
                        <input type="number" name="peso" id="peso" class="form-control form-control-sm" value="{{ old('peso') }}" step="0.01" min="0" required placeholder="Peso">
                    ...
                    <div class="col-md-6 mb-4 form-floating">
                        <input type="number" name="cantidad" id="cantidad" class="form-control form-control-sm" value="{{ old('cantidad') }}" required placeholder="Cantidad">
                        <label for="cantidad">Cantidad</label>
                    </div>

                    <div class="col-md-6 mb-4 form-floating">
                        <input type="text" name="codigo_barras" id="codigo_barras" class="form-control form-control-sm" value="{{ old('codigo_barras') }}" required placeholder="Código de barras">
