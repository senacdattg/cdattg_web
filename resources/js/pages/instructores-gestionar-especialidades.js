/**
 * Script específico para gestionar especialidades de instructores
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Página de gestión de especialidades de instructores inicializada correctamente');
});
