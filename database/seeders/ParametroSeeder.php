...
class ParametroSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $parametros = [
            ...
            ['id' => 188, 'name' => 'AFROCOLOMBIANO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 189, 'name' => 'AFROCOLOMBIANOS DESPLAZADOS POR LA VIOLENCIA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 190, 'name' => 'AFROCOLOMBIANOS DESPLAZADOS POR LA VIOLENCIA CABEZ', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 191, 'name' => 'INDÍGENA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 192, 'name' => 'INDÍGENAS DESPLAZADOS POR LA VIOLENCIA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 193, 'name' => 'INDÍGENAS DESPLAZADOS POR LA VIOLENCIA CABEZA DE F', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 194, 'name' => 'GITANO ROM', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 195, 'name' => 'PALENQUERO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 196, 'name' => 'RAIZAL', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 197, 'name' => 'NEGRO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 198, 'name' => 'MUJER CABEZA DE FAMILIA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 199, 'name' => 'DESPLAZADOS POR LA VIOLENCIA CABEZA DE FAMILIA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 200, 'name' => 'DESPLAZADOS POR FENÓMENOS NATURALES CABEZA DE FAM', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 201, 'name' => 'JÓVENES VULNERABLES', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 202, 'name' => 'ADOLESCENTE TRABAJADOR', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 203, 'name' => 'ADOLESCENTE EN CONFLICTO CON LA LEY PENAL', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 204, 'name' => 'PERSONAS EN PROCESO DE REINTEGRACIÓN', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 205, 'name' => 'EMPRENDEDORES', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 206, 'name' => 'MICROEMPRESAS', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 207, 'name' => 'ARTESANOS', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 208, 'name' => 'CAMPESINO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 209, 'name' => 'SOLDADOS CAMPESINOS', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 210, 'name' => 'DISCAPACIDAD INTELECTUAL', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 211, 'name' => 'DISCAPACIDAD AUDITIVA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 212, 'name' => 'DISCAPACIDAD FÍSICA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 213, 'name' => 'DISCAPACIDAD VISUAL', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 214, 'name' => 'DISCAPACIDAD PSICOSOCIAL', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 215, 'name' => 'DISCAPACIDAD MÚLTIPLE', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 216, 'name' => 'SORDOCEGUERA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 217, 'name' => 'DESPLAZADOS DISCAPACITADOS', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 218, 'name' => 'ABANDONO O DESPOJO FORZADO DE TIERRAS', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 219, 'name' => 'ACTOS TERRORISTA ATENTADOS COMBATES ENFRENTAMIENTOS HOSTIGAMIENTOS', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 220, 'name' => 'ADOLESCENTE DESVINCULADO DE GRUPOS ARMADOS ORGANIZ', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 221, 'name' => 'DELITOS CONTRA LA LIBERTAD Y LA INTEGRIDAD SEXUAL EN DESARROLLO DEL CONFLICTO ARMADO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 222, 'name' => 'DESAPARICIÓN FORZADA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 223, 'name' => 'DESPLAZADOS POR LA VIOLENCIA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 224, 'name' => 'RECLUTAMIENTO FORZADO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 225, 'name' => 'SECUESTRO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 226, 'name' => 'HOMICIDIO MASACRE', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 227, 'name' => 'HERIDO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 228, 'name' => 'SOBREVIVIENTES MINAS ANTIPERSONALES', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 229, 'name' => 'MINAS ANTIPERSONAL MUNICIÓN SIN EXPLOTAR Y ARTEFACTO EXPLOSIVO IMPROVISADO', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 230, 'name' => 'AMENAZA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 231, 'name' => 'DESPLAZADOS POR FENÓMENOS NATURALES', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 232, 'name' => 'INPEC', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 233, 'name' => 'REMITIDOS POR EL CIE', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 234, 'name' => 'REMITIDOS POR EL PAL', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
            ['id' => 235, 'name' => 'NINGUNA', 'status' => 1, 'user_create_id' => 1, 'user_edit_id' => 1],
